...
double contirpratras = 25000000;
double contr3num = 25000000;
...
Action proximo90 = () => {
    if (bussolar () > 314 || bussolar () < 45) {
        while (bussolar () < 90) {
            rotacionarr (1000, 1);
            printr (3, bussolar ().ToString ());
        }
    } else if (bussolar () > 44 && bussolar () < 135) {
        while (bussolar () < 180) {
            rotacionarr (1000, 1);
            printr (3, bussolar ().ToString ());
        }
    } else if (bussolar () > 134 && bussolar () < 225) {
        while (bussolar () < 270) {
            rotacionarr (1000, 1);
            printr (3, bussolar ().ToString ());
        }
    } else if (bussolar () > 224 && bussolar () < 315) {
        while (bussolar () > 5) {
            rotacionarr (1000, 1);
            printr (3, bussolar ().ToString ());
...
while (true) {
    ...
    if (flag == 0) {
        ...
        if (contencruz > 0) contencruz++;
        if (contencruz == tempoencruz) {
            contencruz = 0;
            encruzant = 0;
        }
       ...
       //verificar entrada na area de resgate
        ...
        print (1, curvaanterior.ToString () + " || " + supergap.ToString () + " || " + dirtxt + " || " + dirmax.ToString () + " || " + contencruz.ToString ());
    ...
    if (flag == 2) { ///////////////////comeco da procura
        ...
        if (ultrar (2) < 10 && ultrar (0) > 20) {
            ...
            if (ultrar (2) < 12) {
                motor (0, 0);
                if (bc.lightness (5) < 65) {
                    while (!bc.detectDistance (2, 1, 20)) {
                        rotacionarr (700, -1);
                    }
                    while (bc.detectDistance (2, 1, 20)) {
                        rotacionarr (700, 1);
                    }
                    while (bc.lightness (4) > 65) {
                        rotacionarr (700, 1);
                    }
        ...
        if (bc.detectDistance (1, 20, 190)) {
            ...
            flagr1 = 0;
            contr3 = 0;
            while (bc.detectDistance (1, 25, 200) && contr3 < contr3num) {
                motor (-100, -100);
                contr3 = contr3 + 1;
            ...
            if (contr3 < (contr3num - 1)) {
                ...
                if (contr3 < (contr3num - 1)) {
                    ...
                    print (1, "parei");
                    contr2 = 0;
                    while (ultrar (0) > 60 && ultrar (2) > 12) {
                        motorr (1000, 1000);
                        print (1, "nao vejo nada");
                    }
                    if (ultrar (2) < 12) {
                        motor (0, 0);
                        ...
                        while (bc.detectDistance (2, 1, 25)) {
                            rotacionarr (700, 1);
                        }
                        while (!bc.detectDistance (2, 1, 25)) {
                            rotacionarr (700, -1);
                        ...
                        while (bc.lightness (5) > 59) {

                            rotacionarr (700, -1);
                        }
                        flagverm = 0;
                        if (bc.returnColor (5) != "VERMELHO") {
                    ...
                    if (ultrar (1) > 5000 && contr6 > 39999999) {
                        while (ultrar (1) > 5000) {
                            motor (1000, 1000);
                        }
                        motor (1000, 1000);
                        ...
                        anterior90 ();
                        if (flagverm == 1) {
                            while (bc.detectDistance (1, 25, 200) && ultrar (0) > 60) {
                                motorr (100, 100);
                            }
                        }
                    }
        ...
        if (contr3 > (contr3num - 1)) {
            while (bc.detectDistance (1, 25, 200) && ultrar (0) > 30) {
                motorr (300, 300);
    ...
    if (flag == 3) {
        ...
        if (corr (0) == "PRETO" || corr (1) == "PRETO" || corr (2) == "PRETO" || corr (3) == "PRETO" || corr (4) == "PRETO") {
            ...
            delayr (200);
            motorr (0, 0);
            while (bc.angleActuator () > 30 || bc.angleActuator () < 2) {
                bc.actuatorDown (1);
            }
            while (bc.hasVictims ()) {
                motor (-100, -100);
        ...
        if (ultrar (0) < parede){ //&& (corr (0) != "PRETO" || corr (1) != "PRETO" || corr (2) != "PRETO" || corr (3) != "PRETO" || corr (4) != "PRETO")) {
                ...
                if (contr3 < (contr3num - 1)) {
                    ...
                    if (ultrar (2) < 12) {
                        ...
                        if (bc.returnColor (5) != "VERMELHO") {
                            ...
                            if (flagr1 == 1) {
                                while ((bc.angleActuator () >= 310 || bc.angleActuator () <= 305) || (bc.angleBucket () >= 320 || bc.angleBucket () <= 310)) {
                                    if (bc.angleBucket () >= 330 || bc.angleBucket () <= 310) {
                                        bc.turnActuatorDown (1);
                    ...
                    contr6 = 0;
                    while (ultrar (0) > 20 && contr6 < 40000000) {
                        if (bc.detectDistance (0, 150, 200)) {
                            motorr (200, 200);
                        }
                        if (bc.detectDistance (0, 100, 150)) {
                            motorr (200, 200);
                        }
                        if (bc.detectDistance (0, 20, 100)) {
                            motorr (100, 100);
                        }
                        contr6++;
                        print (3, contr6.ToString ());
