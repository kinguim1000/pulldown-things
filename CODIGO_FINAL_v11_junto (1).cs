...
while (true) {
    ...
    if (flag == 2) { ///////////////////comeco da procura
        ...
        if (bc.detectDistance (1, 20, 190)) {
            ...
            flagr1 = 0;
            contr3 = 0;
            while (bc.detectDistance (1, 25, 200) && contr3 < 50000000) {
                motor (-100, -100);
                contr3 = contr3 + 1;
            ...
            if (contr3 < 49999999) {
                ...
                if (contr3 < 49999999) {
                    ...
                    if (ultrar (2) < 12) {
                        ...
                        if (bc.lightness (5) > 50 && bc.lightness (5) < 65) {
                    ...
                    contr6 = 0;
                    while (!bc.touch (0) && contr6 < 30000000) {
                        motorr (-200, -200);
                        contr6++;
                    ...
                    if (ultrar (1) > 5000 && contr6 > 29999999) {
                        while (ultrar (1) > 5000) {
                            motor (1000, 1000);
                        }
                        motor (1000, 1000);
        ...
        if (contr3 > 49999999) {
            ...
            //while(bc.detectDistance (1, 25, 200)){
            rotacionarr (1000, 90);
            //            }
        }
        if (bc.hasVictims ()) {
                    ...
                    if (ultrar (2) < 12) {
                        ...
                        if (ultrar (1) > 5000 && contr6 > 29999999) {
                            ...
                            if (!bc.hasVictims () && flagr1 == 0) {
                                motor(-300, -300);
                                delay(100);
                                while (bc.detectDistance (1, 25, 200) && ultrar (1) < 3000) {
                                    motorr (-300, -300);
