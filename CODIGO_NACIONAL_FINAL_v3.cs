...
Action lercores = () => {
    ...
    if (corEsq1 == "AMARELO") corEsq1 = "VERDE";
    if (corEsq == "AMARELO") corEsq = "VERDE";
    if (corCentro == "AMARELO") corCentro = "VERDE";
    if (corDir == "AMARELO") corDir = "VERDE";
    if (corDir1 == "AMARELO") corDir1 = "VERDE";
};
...
if (s0 == s1 && s1 == s2 && ultraFS >= 305 && ultraFS <= 315) {
    motor (150, 150);
    delay (3000);
    areaderesgate ();
} else {
...
if (s2 == s3 && s3 == s4 && ultraFS >= 305 && ultraFS <= 315) {
    motor (150, 150);
    delay (3000);
    areaderesgate ();
} else {
...
if (s1 == s2 && s2 == s3 && ultraFS >= 305 && ultraFS <= 315) {
    motor (150, 150);
    delay (3000);
    areaderesgate ();
} else {
...
*/
        ...
        if (bc.returnRed (1) >= limitearenamin && bc.returnGreen (1) >= limitearenamin && bc.returnBlue (1) >= limitearenamin && bc.returnRed (1) <= limitearenamax && bc.returnGreen (1) <= limitearenamax && bc.returnBlue (1) <= limitearenamax) {
            ...
            areaderesgate ();
        } else if (s0 == s1 && s1 == s2 && ultraFS >= 305 && ultraFS <= 315) {
            areaderesgate ();
        } else if (s2 == s3 && s3 == s4 && ultraFS >= 305 && ultraFS <= 315) {
            areaderesgate ();
        } else if (s1 == s2 && s2 == s3 && ultraFS >= 305 && ultraFS <= 315) {
            areaderesgate ();
        }
    ...
    if (flag == 1) {
        ...
        printr (3, contr1.ToString ());
        printr (1, inclinacaor ().ToString ());

        if (inclinacaor () < 100 || inclinacaor () > 350) {
            contr1 = contr1 + 1;
        }
    ...
    if (flag == 2) {
        ...
        if (bc.detectDistance (1, 25, 200)) {
            contr3 = 0;
            while (bc.detectDistance (1, 25, 200) && contr3 < 8000000) {
                motor (-100, -100);
                contr3 = contr3 + 1;
            ...
            if (contr3 < 8000000) {
                ...
                if (contr3 < 8000000) {
                    ...
                    contr2 = 0;
                    while (ultrar (0) > 60 && contr2 < 17000000 && !bc.hasVictims ()) {
                        motorr (1000, 1000);
                        contr2 = contr2 + 1;
                        print (3, contr2.ToString ());
                    }
                    if (bc.hasVictims ()) {
                        motorr (700, 700);
                        delayr (700);
    ...
    if (flag == 3) {
        ...
        if (ultrar (0) < 50) {
            ...
            if (bc.hasVictims ()) {
                ...
                contr5 = 0;
                while (!bc.touch (0) && contr5 < 45000000) {
                    printr (3, contr5.ToString ());
                    motorr (-150, -150);
                    contr5 = contr5 + 1;
                }
                while (bc.angleBucket () >= 320 || bc.angleBucket () <= 310) {
    ...
    if (flag == 4) {
        ...
        printr (1, bussolar ().ToString ());
        printr (2, ultrar (1).ToString ());
