void Main () {
    ...
    */
    ...
    Action print = () => {
        if (bc.timer () > printdelay) {
            ...
            bc.printLCD (1, "FS:" + ultraFS.ToString () + ",FI:" + ultraFI.ToString () + ",L:" + ultraL.ToString () + "||B:" + direcao.ToString () + ",I:" + inclatual.ToString () + "||T:" + t.ToString () + "||Balde:" + aB.ToString () + ",At:" + aA.ToString ());
        }
    ...
    */
        ...
        while (posbuss <= target1) {
            ...
            if ((dist1 - dist2) > 15) {
                ...
                if ((dist1 - dist2) > 15) {
                    ...
                    gapdir (35, 3);
                    lercores ();
                    while (ultraFS > 30 && ultraFI > 5) {
                        motor (200, 200);
                        lercores ();
                        while ((ultraFS > 30 && ultraFS < 50) && (ultraFI > 5 && ultraFI < 15)) {
                            motor (150, 150);
                            lercores ();
                        }
                    }
            ...
            bc.printLCD (2, posbuss.ToString () + " || " + target1.ToString () + " || ");
    ...
    Func<int> procarea = () => {
        ...
        while (locarea == 0) {
            while (bc.distance (0) >= 83) motor (vel + 10, vel + 10);
            if (bc.distance (2) <= 35) {
                motor (1000, -1000);
                delay (500);
