...
double contirpratras = 12000000;////////tanto pra ir pra tras depois do preto
double contr3num = 25000000;/////////// contador pra ir pra tras e pra frente na procura lateral
        ...
        if (bc.detectDistance (1, 20, 190)) {
            ...
            if (contr3 < contr3num - 1) {
                ...
                if (contr3 < contr3num - 1) {
                    ...
                    if (ultrar (1) > 5000 && ultrar(0) > 270 && contr6 > 39999999 && !bc.touch(0)) {
                        while (ultrar (1) > 5000) {
                            motor (1000, 1000);
                        }
                        motor (1000, 1000);
