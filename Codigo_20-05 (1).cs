void Main () {
    ...
    */
    ...
    Action ajustemotor = () => {
        ...
        if (corEsq == corDir && corEsq != "VERDE" && s3 > 28 && s1 > 28) {
    ...
    */
            ...
            if ((dist1 - dist2) > 15) {
                ...
                if ((dist1 - dist2) > 15) {
                    ...
                    if (corbola == "PRETO" || corbola == "BRANCO") {
                        ...
                        if (corbola == "BRANCO") { //resgatar a vitima
                    ...
                    //descarregar vitima
                    //ir para tras e frente erro sistema
                    motor (-100, -100);
                    delay (100);
                    motor (100, 100);
                    delay (100);
    ...
    Func<int> procarea = () => {
        ...
        while (locarea == 0) {
            while (bc.distance (0) >= 90) motor (300, 300);
            if (bc.distance (2) <= 35) {
                motor (1000, -1000);
                delay (500);
