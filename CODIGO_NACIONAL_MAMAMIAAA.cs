        ...
        if (bc.detectDistance (1, 25, 200)) {
            ...
            if (contr3 < 8000000) {
                ...
                if (contr3 < 8000000) {
                    ...
                    contr2 = 0;
                    while (ultrar (0) > 60 && contr2 < 35000000 && !bc.hasVictims ()) {
                        motorr (1000, 1000);
                        contr2 = contr2 + 1;
                    ...
                    if (bc.hasVictims ()) {
                        contr7 = 0;
                        while (contr7 < 600000 && bc.hasVictims ()) {
                            motorr (700, 700);
                            contr7 = contr7 + 1;
                            while (bc.angleActuator () >= 310 || bc.angleActuator () <= 305) {
                                bc.actuatorUp (1);
                        ...
                        contr6 = 0;
                        while (!bc.touch (0) && contr6 < 4000000) {
                            motor (-200, -200);
                            contr6 = contr6 + 1;
                        }
                        motor (100, 100);
